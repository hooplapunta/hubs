		function inject_slideshow_Media() {
		    ...
		    AFRAME.registerComponent("slidemenu-pager", {
		        ...
		        init() {
		            ...
		            this.content = slideconfig.slides; // ANNOTA we can grab data from here
		            ...
		            this.el.components["hover-menu__pager"].getHoverMenu().then(menu => {
		                ...
		                // ANNOTA: move previous and next buttons
		                // this.prevButton.setAttribute("position", "-0.5 1 0");
		        ...
		        async update(oldData) {
		            ...
		            // ANNOTA: probably where we will update the position of the buttons
		        },
		    ...
		    menuEntity.innerHTML = "<a-entity class='prev-button' position='-0.50 0 0'><a-entity is-remote-hover-target tags='singleActionButton:true; isHoverMenuChild: true;' mixin='rounded-text-button' slice9='width: 0.2' material='color: white; opacity: 0.1; transparent: true'></a-entity></a-entity>" +
		        ...
		        "<a-entity class='next-button' position='0.50 0 0'><a-entity is-remote-hover-target tags='singleActionButton:true; isHoverMenuChild: true;' mixin='rounded-text-button' slice9='width: 0.2' material='color: white; opacity: 0.1; transparent: true'></a-entity></a-entity>";
		    ...
		    AFRAME.registerComponent("slide-element", {
		        schema: {
		            index: { default: 0 },
		            slideScale: { default: 3 } // ANNOTA: change default size here
		        },
		...
		function mod_addSlides() {
		    ...
		    el.object3D.position.y = 2; // ANNOTA: default position of the object
